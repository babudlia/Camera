...
def get_jetson_gstreamer_source(capture_width=1280, capture_height=960, display_width=1280, display_height=960, framerate=20, flip_method=0):
    """
    Return an OpenCV-compatible video source description that uses gstreamer to capture video from the camera on a Jetson Nano
    """
    return (
	    "tcambin serial=50910677 ! videoscale ! video/x-raw, format=BGRx,width= 1280,height=960,framerate=20/1 ! videoconvert ! appsink", cv2.CAP_GSTREAMER
            )
