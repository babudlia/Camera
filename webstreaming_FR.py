...
def get_jetson_gstreamer_source(capture_width=1280, capture_height=960, display_width=1280, display_height=960, framerate=60, flip_method=0):
    """
    ...
    return (
            ...
            'video/x-raw, format=(string)BGR ! videoconvert ! videoscale ! appsink'
            )
